    ...
    genDebugData: function (num) {
        var debugInfo = {
            ...
            'generalInfo': {
                ...
                room_hongbao_cnt: 0,
                room_hongbao_money: 87123131,
                room_migrate: 23,

            },
            'filterInfo': {
                'type': 'room_hongbao_money',
                'date': 'month',
...
var Analysis = {
    ...
    onUpPushStatus: function (e) {
        ...
        filterScheme = 'wxwork://jump?target=group_analysis_set_top_rank_switch&open=' + self.PushStatus;
    ...
    renderGeneralInfo: function (generalInfo) {
        ...
        $.each(generalInfo, function (key, item) {
            var value = item;
            if (key.toLowerCase() == 'room_hongbao_money') {
                console.log(value)
                value = value + '';
                // 特殊处理 w 以上的数据
                if (value.length > 7) {
    ...
    renderHighChart: function (listdata, filterInfo) {
        ...
        if (filterInfo && filterInfo.type) {
            ...
            if (filterInfo.type == 'room_hongbao_money') {
                unit = language['yuan'];
            }
        }
