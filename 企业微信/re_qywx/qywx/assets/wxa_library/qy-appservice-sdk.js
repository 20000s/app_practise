...
var initOnPageCall = function initOnPageCall() {
  onMethod('onCheckAppShareMessageEnable', function () {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return invokeShareByKey('checkAppShareMessageEnable', args);
  });
  onMethod('onForwardAppMessage', function () {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return invokeShareByKey('sendMessageToConv', args);
  });
  onMethod('onNFCReadMessage', function () {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    invokeInCurrentPage('onNFCReadMessage', args);
  });
  onMethod('onUserOpStatistic', function () {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    invokeInCurrentPage('onUserOpStatistic', args);
  });
};

var invokeShareByKey = function invokeShareByKey(key, args) {
  var pages = getCurrentPages();

  if (pages && pages.length > 0) {
    var customShareData = invokeInCurrentPage('onShareAppMessage', args) || {};
    var shareData = args;
...
var invokeInCurrentPage = function invokeInCurrentPage(key) {
